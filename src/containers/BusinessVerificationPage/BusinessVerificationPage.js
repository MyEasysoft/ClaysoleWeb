...
export const BusinessVerificationComponent = props => {
    const {
        saveEmailError,
...
BusinessVerificationComponent.defaultProps = {
  saveEmailError: null,
...
BusinessVerificationComponent.propTypes = {
...
const BusinessVerificationPage = compose(
    connect(
        mapStateToProps,
        mapDispatchToProps
      ),
